...
npx terser dist/seidr.no-ssr.js -o dist/seidr.no-ssr.min.js --toplevel -c passes=2 -c ecma=2023 -m --module > /dev/null 2>&1 || true

# Compress the bundles
gzip -f -k dist/seidr.min.js
gzip -f -k dist/seidr.no-ssr.min.js
