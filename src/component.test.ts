...
import { component, createScope, mount, mountConditional, mountList, mountSwitch } from "./component.js";
...
describe("mountConditional", () => {
  ...
  it("should toggle component based on condition changes", () => {
    ...
    const conditional = mountConditional(condition, () => component(() => mockElement), container);
