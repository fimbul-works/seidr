...
const TodoItem = component(({ todo, onUpdate, onDelete }: { todo: Todo; onUpdate: () => void; onDelete: () => void }) => {
...
export const TodoApp = component((initialTodos: Todo[] = [{ id: Date.now(), text: "Learn Seidr", completed: false }]) => {
